...
├── docs/                     ← the full documentation package (see table below)
│   ├── PROJECT_REPORT.md     ← ready-to-submit college documentation (template-based)
│   ├── VIVA.md               ← 25 likely viva questions with short ready answers
...
| **[Viva prep](docs/VIVA.md)** | Students | 25 likely viva questions with short, ready-to-say answers |
